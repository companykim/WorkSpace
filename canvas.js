var context;			/* 컨텍스트 객체*/
	...
	image.src = "./images/grass.jpg";		/* 이미지 파일 이름 설정 */
	var netImage = new Image();
	netImage.src = "./images/net.jpg";
	var timer;
	...
	function init() {
		...
		ballY = 250;
		ballRadius = 10;
		context = document.getElementById('fortressCanvas').getContext('2d');
		draw();
	}
	...
	function drawBackground() {
		...
		context.drawImage(netImage, 450, 60, 30, 200);
	}